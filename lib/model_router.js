    ...
    this.providers = [
      {
        ...
        models: ['minimax-m3', 'deepseek-v4-flash-0731', 'qwen-3.8', 'deepseek-v4', 'gpt-5.4', 'minimax-m2.7', 'claude-3-7-sonnet'],
        maxConcurrent: 4,
        running: 0
      },
      {
        ...
        models: ['minimax-m2.7', 'deepseek-chat', 'gpt-5.4', 'claude-3-7-sonnet', 'gpt-4o'],
        maxConcurrent: 3,
        running: 0
      },
      {
        ...
        models: ['gpt-4o-mini', 'deepseek-v3', 'deepseek-r1', 'gpt-4o', 'claude-3-5-sonnet-20241022'],
        maxConcurrent: 2,
        running: 0
      },
      {
    ...
    for (let round = 1; round <= 3; round++) {
      ...
      for (const provider of this.providers) {
        ...
        for (const model of provider.models) {
          ...
          if (taskType === 'deep_reasoning' && !model.includes('r1') && !model.includes('v4') && !model.includes('sonnet') && !model.includes('5.4')) {
            continue;
          }
