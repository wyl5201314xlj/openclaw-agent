# -*- coding: utf-8 -*-
"""为热点推送功能重新配置 Render 环境变量 MASTER_OPENID（代码已恢复引用）。
...
if not master_openid:
    raise SystemExit('凭据库未配置 qq_bot_openclaw.master_openid')
...
current.setdefault('HOTNEWS_SCHEDULE', '08:30')
...
print('HOTNEWS_SCHEDULE 已配置:', 'HOTNEWS_SCHEDULE' in keys)
